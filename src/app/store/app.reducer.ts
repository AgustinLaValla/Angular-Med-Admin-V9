...
//Pacinet Selector
export const getPacientState = createFeatureSelector<fromPACIENT.PacientState>('pacient');
export const getPacient = createSelector(getPacientState, fromPACIENT.getPacientSelector);
export const getPacientError = createSelector(getPacientState, fromPACIENT.getPacientErrorSelector);
//Auth Selector
